...
class MembreRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    */
    ...
    public function transform(Membre $article)
    {
        return [
                ...
                'password'   => (string) $article->getPassword(),  
                'telephone'=> (string) $article->getTelephone(),  
        ];
    }
    ...
    public function removeoffre(Membre $offre)
    {
